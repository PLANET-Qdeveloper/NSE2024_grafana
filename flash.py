...
# シリアルポートの設定
ser = serial.Serial('COM12', 115200)  # COMポートは受信機とつながってるやつの番号をThonnyなりデバイスマネージャーなりで確認してね

# 保存先のCSVファイルを指定
logdata_csv_file_path = 'C:\\Users\\jun15\\Documents\\Planet-Q\\電装\\地上局\\NSE2024_grafana\\logdata.csv'  # 適宜変更
...
while True:
    try:
        if ser.in_waiting:
            ...
            with open(logdata_csv_file_path, mode='a', newline='') as file:
                writer = csv.writer(file, quoting=csv.QUOTE_MINIMAL)
